...
;; 
;; board action has changed: (origin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (destin ?passenger ?floor), (origin ?passenger ?floor), 
;; depart action has changed: (lift_at ?floor), (destin ?passenger ?floor), (origin ?passenger ?floor), 
;; down action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), (above ?floor1 ?floor2), 
;; up action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), (lift_at ?floor1), 
