...
;; board action has changed: (destin ?passenger ?floor), (origin ?passenger ?floor), (origin ?passenger ?floor), (lift_at ?floor), (destin ?passenger ?floor), 
;; depart action has changed: (destin ?passenger ?floor), (served ?passenger), 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), 
