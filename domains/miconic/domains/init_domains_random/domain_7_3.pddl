...
;; 
;; down action has changed: (above ?floor1 ?floor2), 
;; board action has changed: (destin ?passenger ?floor), (served ?passenger), (served ?passenger), 
;; depart action has changed: (destin ?passenger ?floor), (origin ?passenger ?floor), 
