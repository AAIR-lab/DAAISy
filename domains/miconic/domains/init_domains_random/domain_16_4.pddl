...
;; 
;; up action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor1 ?floor2), 
;; depart action has changed: (lift_at ?floor), (origin ?passenger ?floor), (origin ?passenger ?floor), (lift_at ?floor), 
;; board action has changed: (served ?passenger), (boarded ?passenger), (served ?passenger), (origin ?passenger ?floor), 
