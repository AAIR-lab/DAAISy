...
;; 
;; depart action has changed: (boarded ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
;; down action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), (above ?floor2 ?floor1), 
;; up action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), 
;; board action has changed: (served ?passenger), 
