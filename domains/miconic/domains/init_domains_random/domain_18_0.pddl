...
;; 
;; board action has changed: (served ?passenger), (lift_at ?floor), (origin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), (served ?passenger), (destin ?passenger ?floor), 
;; depart action has changed: (origin ?passenger ?floor), (boarded ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (lift_at ?floor), 
