...
;; 
;; depart action has changed: (origin ?passenger ?floor), (boarded ?passenger), (boarded ?passenger), (destin ?passenger ?floor), 
;; board action has changed: (served ?passenger), (boarded ?passenger), (served ?passenger), (lift_at ?floor), (boarded ?passenger), 
