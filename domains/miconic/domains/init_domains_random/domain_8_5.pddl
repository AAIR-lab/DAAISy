...
;; 
;; depart action has changed: (destin ?passenger ?floor), (lift_at ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
;; board action has changed: (boarded ?passenger), (served ?passenger), 
