...
;; 
;; board action has changed: (destin ?passenger ?floor), (destin ?passenger ?floor), (served ?passenger), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor2), 
;; depart action has changed: (origin ?passenger ?floor), (destin ?passenger ?floor), (origin ?passenger ?floor), (destin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (boarded ?passenger), 
;; up action has changed: (lift_at ?floor1), (lift_at ?floor1), (above ?floor2 ?floor1), 
