...
;; 
;; depart action has changed: (origin ?passenger ?floor), (destin ?passenger ?floor), (lift_at ?floor), (boarded ?passenger), (boarded ?passenger), (lift_at ?floor), (served ?passenger), 
;; board action has changed: (boarded ?passenger), (origin ?passenger ?floor), (lift_at ?floor), (served ?passenger), 
;; down action has changed: (above ?floor2 ?floor1), (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
;; up action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), (lift_at ?floor2), 
