...
;; 
;; up action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), 
;; board action has changed: (served ?passenger), (destin ?passenger ?floor), (served ?passenger), (destin ?passenger ?floor), 
;; down action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
