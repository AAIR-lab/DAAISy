...
;; 
;; board action has changed: (served ?passenger), (lift_at ?floor), (lift_at ?floor), 
;; depart action has changed: (boarded ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; down action has changed: (above ?floor2 ?floor1), (above ?floor2 ?floor1), 
;; up action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor2), 
