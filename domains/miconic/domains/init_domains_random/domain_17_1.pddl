...
;; 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor1), (lift_at ?floor2), (above ?floor2 ?floor1), 
;; board action has changed: (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), 
;; depart action has changed: (served ?passenger), (boarded ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
