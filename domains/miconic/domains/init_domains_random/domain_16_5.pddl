...
;; 
;; board action has changed: (lift_at ?floor), (boarded ?passenger), (served ?passenger), (lift_at ?floor), 
;; down action has changed: (lift_at ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), (above ?floor1 ?floor2), 
;; depart action has changed: (destin ?passenger ?floor), (served ?passenger), (lift_at ?floor), (origin ?passenger ?floor), (boarded ?passenger), 
;; up action has changed: (lift_at ?floor1), (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
