...
;; 
;; up action has changed: (lift_at ?floor1), (above ?floor2 ?floor1), (above ?floor2 ?floor1), 
;; depart action has changed: (origin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), (boarded ?passenger), (origin ?passenger ?floor), 
;; board action has changed: (destin ?passenger ?floor), (lift_at ?floor), 
;; down action has changed: (above ?floor2 ?floor1), 
