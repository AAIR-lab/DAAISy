...
;; 
;; board action has changed: (boarded ?passenger), (destin ?passenger ?floor), 
;; up action has changed: (lift_at ?floor1), (lift_at ?floor2), 
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), 
