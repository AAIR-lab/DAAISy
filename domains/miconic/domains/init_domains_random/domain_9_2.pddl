...
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), (destin ?passenger ?floor), (served ?passenger), (served ?passenger), 
;; board action has changed: (destin ?passenger ?floor), (boarded ?passenger), 
