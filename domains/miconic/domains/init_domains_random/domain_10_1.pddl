...
;; 
;; up action has changed: (above ?floor2 ?floor1), 
;; board action has changed: (served ?passenger), (lift_at ?floor), (boarded ?passenger), (boarded ?passenger), (served ?passenger), 
;; depart action has changed: (boarded ?passenger), (served ?passenger), 
;; down action has changed: (lift_at ?floor2), (lift_at ?floor2), 
