...
;; 
;; board action has changed: (destin ?passenger ?floor), (served ?passenger), (origin ?passenger ?floor), (origin ?passenger ?floor), (destin ?passenger ?floor), 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor1 ?floor2), (lift_at ?floor1), (lift_at ?floor2), 
;; down action has changed: (lift_at ?floor2), 
;; depart action has changed: (lift_at ?floor), (served ?passenger), (served ?passenger), 
