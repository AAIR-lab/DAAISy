...
;; 
;; depart action has changed: (served ?passenger), (origin ?passenger ?floor), (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), 
;; board action has changed: (served ?passenger), (lift_at ?floor), (destin ?passenger ?floor), (origin ?passenger ?floor), (served ?passenger), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), 
;; up action has changed: (lift_at ?floor2), (lift_at ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), 
