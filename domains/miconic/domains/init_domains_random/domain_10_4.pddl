...
;; 
;; board action has changed: (served ?passenger), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
;; depart action has changed: (origin ?passenger ?floor), (served ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; down action has changed: (lift_at ?floor2), (lift_at ?floor1), 
