...
;; 
;; depart action has changed: (boarded ?passenger), (origin ?passenger ?floor), (origin ?passenger ?floor), (destin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (boarded ?passenger), 
;; board action has changed: (boarded ?passenger), (origin ?passenger ?floor), (lift_at ?floor), (boarded ?passenger), (served ?passenger), 
;; up action has changed: (lift_at ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), (above ?floor2 ?floor1), 
;; down action has changed: (lift_at ?floor1), (lift_at ?floor2), 
