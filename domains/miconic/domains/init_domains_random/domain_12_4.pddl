...
;; board action has changed: (lift_at ?floor), (origin ?passenger ?floor), (served ?passenger), 
;; up action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), (lift_at ?floor1), 
;; depart action has changed: (destin ?passenger ?floor), (boarded ?passenger), (origin ?passenger ?floor), (boarded ?passenger), 
