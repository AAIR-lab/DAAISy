...
;; 
;; depart action has changed: (served ?passenger), (lift_at ?floor), (lift_at ?floor), (boarded ?passenger), 
;; board action has changed: (destin ?passenger ?floor), (served ?passenger), (origin ?passenger ?floor), (boarded ?passenger), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), (lift_at ?floor2), (lift_at ?floor1), 
;; up action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor1), 
