...
;; 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), (lift_at ?floor2), (lift_at ?floor1), 
;; depart action has changed: (origin ?passenger ?floor), (served ?passenger), (served ?passenger), (lift_at ?floor), (lift_at ?floor), (destin ?passenger ?floor), 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), 
