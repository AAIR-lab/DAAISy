...
;; 
;; up action has changed: (lift_at ?floor1), (lift_at ?floor1), 
;; depart action has changed: (destin ?passenger ?floor), (boarded ?passenger), (origin ?passenger ?floor), 
;; down action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), 
;; board action has changed: (boarded ?passenger), 
