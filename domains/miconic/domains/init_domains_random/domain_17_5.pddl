...
;; 
;; board action has changed: (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), (served ?passenger), (lift_at ?floor), (boarded ?passenger), (destin ?passenger ?floor), 
;; up action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), 
;; depart action has changed: (lift_at ?floor), (boarded ?passenger), (served ?passenger), (origin ?passenger ?floor), 
;; down action has changed: (above ?floor2 ?floor1), (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor1 ?floor2), 
