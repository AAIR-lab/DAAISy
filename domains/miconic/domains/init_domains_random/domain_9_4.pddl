...
;; 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), 
;; board action has changed: (lift_at ?floor), (served ?passenger), (destin ?passenger ?floor), 
;; depart action has changed: (lift_at ?floor), 
;; up action has changed: (lift_at ?floor2), 
