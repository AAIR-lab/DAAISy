...
;; 
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (origin ?passenger ?floor), (origin ?passenger ?floor), 
;; down action has changed: (above ?floor1 ?floor2), (above ?floor2 ?floor1), 
;; board action has changed: (lift_at ?floor), (boarded ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
