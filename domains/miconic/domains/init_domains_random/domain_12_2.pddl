...
;; 
;; depart action has changed: (boarded ?passenger), (served ?passenger), (lift_at ?floor), (boarded ?passenger), (served ?passenger), 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), 
;; up action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
;; board action has changed: (origin ?passenger ?floor), 
