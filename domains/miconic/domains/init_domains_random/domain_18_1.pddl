...
;; 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor1), 
;; up action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), 
;; depart action has changed: (boarded ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (destin ?passenger ?floor), (served ?passenger), 
;; board action has changed: (served ?passenger), (boarded ?passenger), (origin ?passenger ?floor), (lift_at ?floor), (destin ?passenger ?floor), 
