...
;; 
;; board action has changed: (served ?passenger), (destin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (above ?floor2 ?floor1), (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), 
;; depart action has changed: (origin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (destin ?passenger ?floor), (boarded ?passenger), 
;; down action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
