...
;; 
;; board action has changed: (destin ?passenger ?floor), (destin ?passenger ?floor), 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), (lift_at ?floor1), 
;; depart action has changed: (boarded ?passenger), 
