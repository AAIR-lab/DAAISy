...
;; board action has changed: (served ?passenger), (served ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; down action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (above ?floor1 ?floor2), 
;; depart action has changed: (origin ?passenger ?floor), (boarded ?passenger), 
