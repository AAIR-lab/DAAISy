...
;; 
;; board action has changed: (destin ?passenger ?floor), (lift_at ?floor), (boarded ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; depart action has changed: (destin ?passenger ?floor), (origin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), (served ?passenger), 
;; up action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), 
;; down action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), 
