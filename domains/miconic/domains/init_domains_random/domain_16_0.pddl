...
;; 
;; board action has changed: (lift_at ?floor), (served ?passenger), (origin ?passenger ?floor), 
;; depart action has changed: (boarded ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (served ?passenger), (boarded ?passenger), (lift_at ?floor), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), (lift_at ?floor1), (lift_at ?floor1), 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor2 ?floor1), (lift_at ?floor1), 
