...
;; 
;; down action has changed: (lift_at ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), 
;; board action has changed: (served ?passenger), (origin ?passenger ?floor), (boarded ?passenger), 
;; depart action has changed: (served ?passenger), (lift_at ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
;; up action has changed: (lift_at ?floor1), (above ?floor2 ?floor1), (lift_at ?floor2), 
