...
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (served ?passenger), 
;; board action has changed: (served ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (boarded ?passenger), 
