...
;; 
;; board action has changed: (boarded ?passenger), (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), 
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), (lift_at ?floor), 
;; up action has changed: (above ?floor1 ?floor2), 
;; down action has changed: (lift_at ?floor1), (lift_at ?floor2), (lift_at ?floor2), (above ?floor1 ?floor2), 
