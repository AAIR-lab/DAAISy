...
;; 
;; depart action has changed: (origin ?passenger ?floor), (boarded ?passenger), (served ?passenger), (lift_at ?floor), (destin ?passenger ?floor), 
;; board action has changed: (destin ?passenger ?floor), (boarded ?passenger), (origin ?passenger ?floor), (served ?passenger), 
