...
;; 
;; depart action has changed: (lift_at ?floor), (origin ?passenger ?floor), (boarded ?passenger), (boarded ?passenger), (destin ?passenger ?floor), 
;; board action has changed: (origin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor1 ?floor2), (lift_at ?floor1), 
;; down action has changed: (above ?floor2 ?floor1), (above ?floor1 ?floor2), (above ?floor1 ?floor2), 
