...
;; 
;; depart action has changed: (lift_at ?floor), (boarded ?passenger), (lift_at ?floor), (destin ?passenger ?floor), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor2), 
;; board action has changed: (lift_at ?floor), (lift_at ?floor), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (above ?floor1 ?floor2), (lift_at ?floor2), 
