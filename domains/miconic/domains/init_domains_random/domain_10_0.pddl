...
;; 
;; depart action has changed: (boarded ?passenger), (origin ?passenger ?floor), (served ?passenger), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), 
;; board action has changed: (origin ?passenger ?floor), (lift_at ?floor), (served ?passenger), (destin ?passenger ?floor), 
