...
;; 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), 
;; up action has changed: (lift_at ?floor1), 
;; board action has changed: (lift_at ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
