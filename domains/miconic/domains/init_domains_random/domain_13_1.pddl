...
;; 
;; board action has changed: (origin ?passenger ?floor), (served ?passenger), (lift_at ?floor), (boarded ?passenger), (boarded ?passenger), 
;; depart action has changed: (destin ?passenger ?floor), (served ?passenger), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor1), 
;; down action has changed: (lift_at ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), 
