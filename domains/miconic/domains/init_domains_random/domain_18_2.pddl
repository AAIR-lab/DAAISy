...
;; 
;; depart action has changed: (boarded ?passenger), (destin ?passenger ?floor), (served ?passenger), (boarded ?passenger), (served ?passenger), (destin ?passenger ?floor), 
;; up action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (above ?floor2 ?floor1), (lift_at ?floor2), 
;; board action has changed: (origin ?passenger ?floor), (destin ?passenger ?floor), (origin ?passenger ?floor), (boarded ?passenger), 
;; down action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), (lift_at ?floor2), 
