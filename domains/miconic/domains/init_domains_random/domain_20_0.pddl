...
;; 
;; depart action has changed: (boarded ?passenger), (lift_at ?floor), (boarded ?passenger), (destin ?passenger ?floor), (served ?passenger), 
;; down action has changed: (lift_at ?floor2), (lift_at ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), (above ?floor1 ?floor2), 
;; board action has changed: (boarded ?passenger), (served ?passenger), (boarded ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), (lift_at ?floor2), 
