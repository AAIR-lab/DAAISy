...
;; 
;; depart action has changed: (origin ?passenger ?floor), (origin ?passenger ?floor), (served ?passenger), (destin ?passenger ?floor), (boarded ?passenger), (boarded ?passenger), 
;; down action has changed: (lift_at ?floor1), (above ?floor2 ?floor1), (lift_at ?floor1), 
;; board action has changed: (served ?passenger), (boarded ?passenger), (lift_at ?floor), (origin ?passenger ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
