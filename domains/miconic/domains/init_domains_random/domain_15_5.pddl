...
;; 
;; up action has changed: (above ?floor2 ?floor1), (above ?floor2 ?floor1), (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor1 ?floor2), 
;; board action has changed: (served ?passenger), (boarded ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (destin ?passenger ?floor), 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), (lift_at ?floor1), 
;; depart action has changed: (served ?passenger), (boarded ?passenger), 
