...
;; 
;; up action has changed: (lift_at ?floor1), (lift_at ?floor2), (lift_at ?floor2), 
;; board action has changed: (lift_at ?floor), (lift_at ?floor), (served ?passenger), 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), 
