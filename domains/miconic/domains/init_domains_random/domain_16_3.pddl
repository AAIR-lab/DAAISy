...
;; 
;; board action has changed: (lift_at ?floor), (served ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (boarded ?passenger), 
;; depart action has changed: (lift_at ?floor), (boarded ?passenger), (served ?passenger), (origin ?passenger ?floor), (lift_at ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (lift_at ?floor1), (above ?floor2 ?floor1), (lift_at ?floor1), 
;; down action has changed: (lift_at ?floor2), 
