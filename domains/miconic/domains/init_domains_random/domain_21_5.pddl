...
;; down action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), (above ?floor2 ?floor1), (lift_at ?floor2), (lift_at ?floor1), 
;; board action has changed: (boarded ?passenger), (destin ?passenger ?floor), (served ?passenger), (origin ?passenger ?floor), (lift_at ?floor), (origin ?passenger ?floor), (boarded ?passenger), 
;; depart action has changed: (boarded ?passenger), (served ?passenger), (destin ?passenger ?floor), (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), 
