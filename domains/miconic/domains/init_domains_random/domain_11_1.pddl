...
;; 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
;; board action has changed: (boarded ?passenger), (destin ?passenger ?floor), (origin ?passenger ?floor), (origin ?passenger ?floor), 
;; depart action has changed: (origin ?passenger ?floor), (destin ?passenger ?floor), 
