...
;; 
;; down action has changed: (above ?floor2 ?floor1), (lift_at ?floor1), 
;; board action has changed: (served ?passenger), (origin ?passenger ?floor), (destin ?passenger ?floor), (lift_at ?floor), (origin ?passenger ?floor), (destin ?passenger ?floor), (lift_at ?floor), 
;; depart action has changed: (served ?passenger), (origin ?passenger ?floor), (boarded ?passenger), 
;; up action has changed: (above ?floor1 ?floor2), (lift_at ?floor2), (above ?floor2 ?floor1), 
