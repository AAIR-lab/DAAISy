...
;; 
;; up action has changed: (lift_at ?floor2), (above ?floor2 ?floor1), 
;; depart action has changed: (served ?passenger), (origin ?passenger ?floor), 
;; board action has changed: (origin ?passenger ?floor), (lift_at ?floor), 
