...
;; 
;; down action has changed: (above ?floor1 ?floor2), (lift_at ?floor1), (lift_at ?floor2), 
;; depart action has changed: (boarded ?passenger), (lift_at ?floor), (lift_at ?floor), (served ?passenger), (boarded ?passenger), (destin ?passenger ?floor), 
;; board action has changed: (served ?passenger), (lift_at ?floor), (destin ?passenger ?floor), (served ?passenger), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), 
