...
;; board action has changed: (boarded ?passenger), (lift_at ?floor), (served ?passenger), (served ?passenger), 
;; depart action has changed: (lift_at ?floor), (destin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), (destin ?passenger ?floor), 
;; up action has changed: (lift_at ?floor1), (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
