...
;; board action has changed: (lift_at ?floor), (origin ?passenger ?floor), (served ?passenger), (served ?passenger), 
;; down action has changed: (above ?floor1 ?floor2), (above ?floor2 ?floor1), (above ?floor2 ?floor1), (lift_at ?floor2), (above ?floor1 ?floor2), 
;; depart action has changed: (boarded ?passenger), (lift_at ?floor), 
