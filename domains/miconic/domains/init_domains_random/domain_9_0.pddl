...
;; 
;; down action has changed: (lift_at ?floor1), (above ?floor1 ?floor2), (above ?floor2 ?floor1), 
;; board action has changed: (destin ?passenger ?floor), (boarded ?passenger), (boarded ?passenger), (destin ?passenger ?floor), 
;; depart action has changed: (lift_at ?floor), (destin ?passenger ?floor), 
