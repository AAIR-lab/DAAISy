...
;; 
;; depart action has changed: (served ?passenger), (served ?passenger), (lift_at ?floor), (origin ?passenger ?floor), 
;; up action has changed: (above ?floor1 ?floor2), (above ?floor2 ?floor1), (lift_at ?floor1), (above ?floor1 ?floor2), 
