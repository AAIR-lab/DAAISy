...
;; 
;; depart action has changed: (boarded ?passenger), (boarded ?passenger), (lift_at ?floor), 
;; down action has changed: (lift_at ?floor2), (above ?floor1 ?floor2), (lift_at ?floor2), 
;; board action has changed: (destin ?passenger ?floor), (destin ?passenger ?floor), (origin ?passenger ?floor), (boarded ?passenger), (lift_at ?floor), (lift_at ?floor), 
;; up action has changed: (lift_at ?floor2), (lift_at ?floor2), 
