(define (domain Rover)
    ...
    (:action navigate
        :parameters (?o1 - rover 
                     ?o2 - waypoint 
                     ?o3 - waypoint) 
        :precondition (and (can-traverse ?o1 ?o2 ?o3) 
                           (available ?o1) 
                           (at ?o1 ?o2) 
                           (visible ?o2 ?o3)
                      )
    ...
    (:action sample-soil
        ...
        :precondition (and (at ?o1 ?o3) 
                           (at-soil-sample ?o3) 
                           (equipped-for-soil-analysis ?o1) 
                           (store-of ?o2 ?o1) 
                           (empty ?o2)
                      )
        :effect (and (not (empty ?o2)) 
                     (full ?o2) 
                     (have-soil-analysis ?o1 ?o3) 
                     (not (at-soil-sample ?o3))
                )
    )
    ...
    (:action sample-rock
        ...
        :precondition (and (at ?o1 ?o3) 
                           (at-rock-sample ?o3) 
                           (equipped-for-rock-analysis ?o1) 
                           (store-of ?o2 ?o1)
                           (empty ?o2)
                      )
        :effect (and (not (empty ?o2)) 
                     (full ?o2) 
                     (have-rock-analysis ?o1 ?o3) 
                     (not (at-rock-sample ?o3))
                )
    )
    ...
    (:action drop
        :parameters (?o1 - rover 
                     ?o2 - store)
        :precondition (and (store-of ?o2 ?o1) 
                           (full ?o2)
                      )
        :effect (and (not (full ?o2)) 
                     (empty ?o2)
                )
    )
    ...
    (:action calibrate
         :parameters (?o1 - rover 
                      ...
                      ?o3 - objective 
                      ?o4 - waypoint)
         :precondition (and (equipped-for-imaging ?o1) 
    ...
    (:action take-image
         ...
         :effect (and (have-image ?o1 ?o3 ?o5)
                      (not (calibrated ?o4 ?o1))
                 )
    )
