(define (problem mixed-f4-p2-u0-v0-g0-a0-n0-a0-b0-n0-f0-r1)
  ...
  (:goal (and (above f0 f1)(above f1 f2)(origin p1 f3)(above f0 f2)(above f2 f3)(destin p0 f1)(origin p0 f0)(destin p1 f0)(above f1 f3)(above f0 f3)(boarded p1)(served p0)(lift-at f0))))