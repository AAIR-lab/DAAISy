(define (problem strips-sat-x-1)
  ...
  (:goal (and (calibration-target instrument0 groundstation2)(on-board instrument0 satellite0)(supports instrument0 thermograph0)(power-on instrument0)(pointing satellite0 groundstation2)(calibrated instrument0))))